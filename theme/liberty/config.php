...
$PAGE->requires->js_call_amd('theme_liberty/libertyscripts', 'init');
...
$THEME->layouts = [
    ...
    'course' => array(
        ...
        'regions' => array('side-pre'),
        'defaultregion' => 'side-pre',
        'options' => array('langmenu' => true, 'course-header-info'=>true),
    ),
